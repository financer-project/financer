...
**Plans**: 6/7 plans executed — 4/4 original plans executed in 3 waves; 3 gap-closure plans added in 2 waves after verification found 2 gaps
Plans:
**Wave 1**

- [x] 01-01-PLAN.md — BUG-01: reproduce the Counterparty filter failure end-to-end, then fix it to the correctness bar (wave 1)
- [x] 01-02-PLAN.md — BUG-02: restore native Tab / Shift+Tab order through the transaction form's date and select fields (wave 1)
...
- [x] 01-05-PLAN.md — Gap 1 / CR-01: make the Counterparty regression test able to fail on the exception it targets, and prove it red; plus WR-01 realPress typing and WR-02 shard-count guard (gap wave 1)
- [x] 01-06-PLAN.md — Gap 2 / TEST-01: enumerate the exact source lines behind the 7-10 line coverage shortfall and cover them deterministically (gap wave 1)
...
|-------|----------------|--------|-----------|
| 1. Bug Fixes & E2E Baseline | 6/7 | In Progress|  |
